...
function EnrollForm() {
  ...
  const validateForm = () => {
    ...
    if (!formData.alt_contact_number || !/^[0-9]{10}$/.test(formData.alt_contact_number)) {
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            {errors.alt_contact_number && (
              <p className="text-red-500 text-xs mt-1">{errors.alt_contact_number}</p>
            )}
          </div>
          ...
          {/* Submission Message */}
          {submissionMessage && (
            <div className={`col-span-1 md:col-span-2 text-center p-3 rounded-lg ${
